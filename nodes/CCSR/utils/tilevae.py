...
def build_task_queue(net, is_decoder):
    ...
    # Some decoder implementations do not define these optional flags.
    give_pre_end = getattr(net, "give_pre_end", False)
    tanh_out = getattr(net, "tanh_out", False)

    if not is_decoder or not give_pre_end:
        task_queue.append(('pre_norm', net.norm_out))
        task_queue.append(('silu', inplace_nonlinearity))
        task_queue.append(('conv_out', net.conv_out))
        if is_decoder and tanh_out:
